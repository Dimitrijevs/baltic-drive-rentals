        ...
        <div class="container">
            <div class="row">
                <div class="card bg-dark text-light mb-4">
                    ...
                    <h3 class="card-title mb-3">Rental Agreement</h3>
                ...
                <div class="card bg-secondary text-light mb-4">
                    ...
                    <h3 class="card-title mb-3">Vehicle Rental</h3>
                    <p class="card-tex text-light">
                        ...
                        This meticulous adherence to the agreed-upon timeline is aimed at enhancing your overall rental experience, 
                ...
                <div class="card bg-dark text-light mb-4">
                    ...
                    <h3 class="card-title mb-3">Renter Requirements</h3>
                    <p class="card-tex text-light">
                        ...
                        insurance coverage or opt to purchase insurance directly from the Company for the duration of the rental. 
                        ...
                        all parties involved and seeks to establish a foundation of trust and responsibility throughout the rental process.
                    </p>
                    </div>
                </div>
                ...
                <div class="card bg-secondary text-light mb-4">
                    ...
                    <p class="card-tex text-light">
                        ...
                        provided it is in good condition and the Renter has adhered to the terms and conditions laid out in this Agreement. 
                    </p>
                    </div>
                </div>
            </div>
